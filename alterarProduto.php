...
<div class="container">
    ...
    <form action="alterarProduto.php" method="POST">
        ...
        <p>Nome: <input type="text" name="nome" size="100" maxlegth="100" pattern="[A-Za-zçÇáÁãÃâÂàÀêÊéÉèÈíÍìÌóÓôÔòÒõÕ\s]{2,30}" title="Nome do produto"  value="<?php echo $linha['nome'] ?>"></p>
        <p>Descrição:  <input type="text" name="descricao" size="150" maxlegth="150" pattern="[0-9]{1,8}\[0-9]{2}" title="Apenas números"  value="<?php echo $linha['descricao'] ?>"></p> 
        <p>Valor R$:   <input type="text" name="valor" size="10" maxlegth="10" pattern="[0-9]{1,8}\[0-9]{2}" title="99.99" value="<?php echo $linha['valor'] ?>"></p> 
